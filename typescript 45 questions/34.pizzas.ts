...
let pizza :string[]= ["bbq","fajita","peperoni"];
for (let pizzas of pizza) {
    console.log(`I really like ${pizzas} pizza`)
    
}
console.log("I really like pizzas alot. There are many kinds of flavours i enjoy too\n"+"Out of which fajita is my abosulte favourite.\n"+"My favourite pizza place is braodway pizza and their 'phantom' pizza is the one i like the most\n"+"over all i really love pizzas");
